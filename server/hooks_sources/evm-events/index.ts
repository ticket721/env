...
export = (strapi: StrapiCtx): Hook => {
    ...
    const evm_events: Hook = {
        ...
        initialize: async (cb: HookCallback): Promise<void> => {
            ...
            if (!strapi.models.address || !strapi.models.action || !strapi.models.ticket || !strapi.models.height || !strapi.models.event || !strapi.models.sale || !strapi.models.eventcontract || !strapi.models.queuedevent || !strapi.models.price) {
            ...
            subscriber(network_config, web3, eb, strapi.models.height, strapi.models.sale, strapi.models.eventcontract, strapi.models.price)
                .then((): void => {
